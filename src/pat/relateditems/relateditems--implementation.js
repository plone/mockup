...
// relateditems.js and run there. pat-relateditems borrows select2 methods;
// they're pulled in via a lazy import of select2--implementation in init
// (this._select2), so neither pattern drags the other into the eager chunk.
export default {
