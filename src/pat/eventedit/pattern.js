...
define(["jquery", "pat-base", "mockup-patterns-pickadate"], function ($, Base) {
    "use strict";
    ...
    var EventEdit = Base.extend({
        ...
        updateEndDate: function () {
            ...
            new_end_date.setMinutes(
                start_date.getMinutes() + self.getTimeDelta()
            );
