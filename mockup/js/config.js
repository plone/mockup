...
(function () {
    ...
    var requirejsOptions = {
        ...
        paths: {
            ...
            "backbone.paginator":
                "node_modules/backbone.paginator/lib/backbone.paginator",
            ...
            "datatables.net-bs":
                "node_modules/datatables.net-bs/js/dataTables.bootstrap",
            "datatables.net-autofill":
                "node_modules/datatables.net-autofill/js/dataTables.autoFill",
            "datatables.net-autofill-bs":
                "node_modules/datatables.net-autofill-bs/js/autoFill.bootstrap",
            "datatables.net-buttons":
                "node_modules/datatables.net-buttons/js/dataTables.buttons.min",
            "datatables.net-buttons-flash":
                "node_modules/datatables.net-buttons/js/buttons.flash.min",
            "datatables.net-buttons-html5":
                "node_modules/datatables.net-buttons/js/buttons.html5.min",
            "datatables.net-buttons-print":
                "node_modules/datatables.net-buttons/js/buttons.print.min",
            "datatables.net-buttons-bs":
                "node_modules/datatables.net-buttons-bs/js/buttons.bootstrap.min",
            "datatables.net-colreorder":
                "node_modules/datatables.net-colreorder/js/dataTables.colReorder.min",
            "datatables.net-buttons-colvis":
                "node_modules/datatables.net-buttons/js/buttons.colVis.min",
            "datatables.net-fixedcolumns":
                "node_modules/datatables.net-fixedcolumns/js/dataTables.fixedColumns.min",
            "datatables.net-fixedheader":
                "node_modules/datatables.net-fixedheader/js/dataTables.fixedHeader.min",
            "datatables.net-keytable":
                "node_modules/datatables.net-keytable/js/dataTables.keyTable.min",
            "datatables.net-responsive":
                "node_modules/datatables.net-responsive/js/dataTables.responsive.min",
            "datatables.net-responsive-bs":
                "node_modules/datatables.net-responsive-bs/js/responsive.bootstrap.min",
            "datatables.net-rowreorder":
                "node_modules/datatables.net-rowreorder/js/dataTables.rowReorder.min",
            "datatables.net-scroller":
                "node_modules/datatables.net-scroller/js/dataTables.scroller.min",
            "datatables.net-select":
                "node_modules/datatables.net-select/js/dataTables.select.min",
            ...
            "jqtree-contextmenu":
                "node_modules/cs-jqtree-contextmenu/src/jqTreeContextMenu",
            ...
            "jquery.recurrenceinput":
                "node_modules/jquery.recurrenceinput.js/src/jquery.recurrenceinput",
            "jquery.tools.dateinput":
                "node_modules/jquery.recurrenceinput.js/lib/jquery.tools.dateinput",
            "jquery.tools.overlay":
                "node_modules/jquery.recurrenceinput.js/lib/jquery.tools.overlay",
            "jquery.tmpl":
                "node_modules/jquery.recurrenceinput.js/lib/jquery.tmpl",
            ...
            "mockup-patterns-formunloadalert":
                "patterns/formunloadalert/pattern",
            "mockup-patterns-inlinevalidation":
                "patterns/inlinevalidation/pattern",
            "mockup-patterns-markspeciallinks":
                "patterns/markspeciallinks/pattern",
            ...
            "mockup-patterns-navigationmarker":
                "patterns/navigationmarker/pattern",
            "mockup-patterns-pickadate": "patterns/pickadate/pattern",
            "mockup-patterns-preventdoublesubmit":
                "patterns/preventdoublesubmit/pattern",
            ...
            "mockup-patterns-resourceregistry":
                "patterns/resourceregistry/pattern",
            ...
            "mockup-patterns-passwordstrength":
                "patterns/passwordstrength/pattern",
            ...
            "tinymce-modern-theme":
                "node_modules/tinymce-builded/js/tinymce/themes/modern/theme",
            ...
            "pat-mockup-parser":
                "node_modules/patternslib/src/core/mockup-parser",
