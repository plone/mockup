    ...
    render: function() {
      ...
      return (
        d.div({ className: 'plone-logo', type: 'button' }, [
          d.span({ key: '0', className: 'plone-logo-screen-reader', style: styles['screen-reader-only'] },
            d.svg(this.props.svg, d.path({ d: this.props.svgpath }))
          ),
          d.span({ key: '1', className: 'plone-logo-wrapper', style: logoStyles.wrapper },
            d.span({ className: 'plone-logo-circle', style: logoStyles.circle },
              d.span({ className: 'plone-logo-innerCircle', style: logoStyles.innerCircle }, [
                d.span({ key: '0', className: 'plone-logo-dot1', style: logoStyles.dot1 }),
                d.span({ key: '1', className: 'plone-logo-dot2', style: logoStyles.dot2 }),
                d.span({ key: '2', className: 'plone-logo-dot3', style: logoStyles.dot3 })
              ])
            )
          )
        ])
