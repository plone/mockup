   ...
   ========================== */
    ...
    describe("Inline Validation", function () {
        ...
        it('A z3c.form input is validated on the "blur" event', function () {
            var widget =
                '<div class="pat-inlinevalidation" data-pat-inlinevalidation=\'{"type": "z3c.form"}\'>' +
            ...
            $.extend(true, Pattern.prototype, {
                validate_z3cform_field: sinon.spy(),
            });
            var pattern = registry.patterns.inlinevalidation.init($el, null, {
                type: "z3c.form",
            });
        ...
        it('A formlib input is validated on the "blur" event', function () {
            var $el = $(
                '<div class="pat-inlinevalidation" data-pat-inlinevalidation=\'{"type": "formlib"}\'> <input type="text"> </div>'
            ).appendTo("body");
            $.extend(true, Pattern.prototype, {
                validate_formlib_field: sinon.spy(),
            });
            var pattern = registry.patterns.inlinevalidation.init($el, null, {
                type: "formlib",
            });
        ...
        it('An archetypes input is validated on the "blur" event', function () {
            var $el = $(
                '<div class="pat-inlinevalidation" data-pat-inlinevalidation=\'{"type": "archetypes"}\'> <input class="blurrable" type="text"> </div>'
            ).appendTo("body");
            $.extend(true, Pattern.prototype, {
                validate_archetypes_field: sinon.spy(),
            });
            var pattern = registry.patterns.inlinevalidation.init($el, null, {
                type: "archetypes",
            });
