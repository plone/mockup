define([
    ...
    var Page = React.createClass({
        ...
        componentDidUpdate: function () {
            var currentPage = Backbone.history.location.hash
                .substr(1)
                .split("/");
            if (currentPage.length > 1) {
                $(window).scrollTop(
                    $("#" + currentPage[1]).offset().top -
        ...
        render: function () {
            ...
            if (page.autotoc) {
                ...
                if (
                    Backbone.history.location.hash.substr(1).split("/").length >
                    1
                ) {
                    patternID = Backbone.history.location.hash
                        .substr(1)
                        .split("/")[1];
                }

                PageContent = div(
                    { className: "row mockup-patterns" },
            ...
            return div({ className: "mockup-content", id: "content" }, [
                div(
                ...
                div(
                    { className: "container" },
                    div(
                        { key: page.id, className: "page-content" },
                        PageContent
                    )
                ),
            ]);
