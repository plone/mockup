...
describe("Related Items", function () {
    ...
    it("test initialize", function () {
        initializePattern();
        utils.timeout(100);
        expect($(".select2-container-multi"), $container).toHaveLength(1);
        expect($(".pattern-relateditems-container"), $container).toHaveLength(1);
        expect(
    ...
    it("auto roundtrip", function () {
        ...
        expect(
            $(
                ".pattern-relateditems-result-select .pattern-relateditems-result-info"
            )
        ).toHaveLength(5);
        ...
        expect($(".pattern-relateditems-result")[0].textContent).toContain(
            "One level up"
        );

        // Select first image
        $(
            'a.pattern-relateditems-result-select[data-path="/folder2/image17"]'
        ).click();
        ...
        clock.tick(1000);
        $(
            ".pattern-relateditems-result.one-level-up a.pattern-relateditems-result-browse"
        )[0].click();
        clock.tick(1000);
    ...
    it("browse roundtrip", function () {
        ...
        expect(
            $(
                ".pattern-relateditems-result-select.selectable .pattern-relateditems-result-info"
            )
        ).toHaveLength(2);
    ...
    it("search roundtrip", function () {
        ...
        //  // add first from result
        $(
            'a.pattern-relateditems-result-select[data-path="/folder2/document15"]'
        ).click();
    ...
    it("use recently used", function () {
        ...
        expect(
            $($(".pattern-relateditems-recentlyused-select")[1]).data("uid")
        ).toEqual("UID6");
    ...
    it("limit recently used", function () {
        ...
        expect($(".pattern-relateditems-recentlyused-select").length).toEqual(2);
        expect(
            $($(".pattern-relateditems-recentlyused-select")[0]).data("uid")
        ).toEqual("UID9");
        expect(
