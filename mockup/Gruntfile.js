...
module.exports = function (grunt) {
    ...
    for (var i = 0; i < mockup.patterns.length; i = i + 1) {
        if (mockup.patterns[i].indexOf("-url") === -1) {
            ...
            docsExtraIncludes.push(
                "text!" + requirejsOptions.paths[mockup.patterns[i]] + ".js"
            );
        }
    }
        ...
        "docs",
        {
            ...
            sed: {
                ...
                "docs-legacy-js": {
                    ...
                    replacement:
                        '<script src="docs-legacy.js"></script>\n<script src="node_modules/requirejs/require.js"></script>',
                },
                "docs-catalogurl": {
                    path: "docs/dev/index.html",
                    pattern: 'data-i18ncatalogurl="/tests/json/i18n.json"',
                    replacement:
                        'data-i18ncatalogurl="/mockup/dev/tests/json/i18n.json"',
                },
            },
        },
        {
