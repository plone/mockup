...
(function() {
  ...
  var requirejsOptions = {
    ...
    paths: {
      ...
      'mockup-tinymce-linktype-base': 'patterns/tinymce/js/linktype_base',
      'mockup-tinymce-linktype-anchor': 'patterns/tinymce/js/linktype_anchor',
      'mockup-tinymce-linktype-email': 'patterns/tinymce/js/linktype_email',
      'mockup-tinymce-linktype-external': 'patterns/tinymce/js/linktype_external',
      'mockup-tinymce-linktype-externalImage': 'patterns/tinymce/js/linktype_externalimage',
      'mockup-tinymce-linktype-image': 'patterns/tinymce/js/linktype_image',
      'mockup-tinymce-linktype-internal': 'patterns/tinymce/js/linktype_internal',
      'mockup-tinymce-linktype-upload': 'patterns/tinymce/js/linktype_upload',
      'mockup-tinymce-linktype-uploadImage': 'patterns/tinymce/js/linktype_uploadimage',
      'mockup-ui-url': 'js/ui',
