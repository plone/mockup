  ...
  ========================== */
    ...
    describe("Select2", function () {
        beforeEach(function () {
            ...
            this.server.respondWith("GET", /select2-ajax\.json/, function (
                xhr,
                id
            ) {
                var items = [
        ...
        it("ajax vocabulary url configuration", function () {
            ...
            expect(select2.options.ajax.url).to.equal(
                "select2-users-vocabulary"
            );
        });
        ...
        it("displays the vocabulary when clicking an empty checkbox", function () {
            ...
            expect(
                $results.first().hasClass("select2-highlighted")
            ).to.be.equal(true);
        ...
        it.skip("handles orderable tag drag events", function () {
            ...
            expect(firstElem.hasClass("select2-choice-dragging")).to.equal(
                false
            );
        ...
        it("HTML multiple select widget converted to hidden inuput, before applying select2", function () {
            ...
            expect($("#test-select2", $el).hasClass("pat-select2")).to.equal(
                true
            );
