...
server.xhr.addFilter(function (method, url) {
    ...
    return url.indexOf("tests/json/") !== -1 || url.indexOf("ace/lib") !== -1;
});
...
server.respondWith(/relateditems-test\.json/, function (xhr, id) {
    var searchables = [
        {
            UID: "jasdlfdlkdkjasdf",
            Title: "Some Image",
            path: "/test.png",
            portal_type: "Image",
        },
        {
            UID: "asdlfkjasdlfkjasdf",
            Title: "News",
            path: "/news",
            portal_type: "Folder",
        },
        {
            UID: "124asdfasasdaf34",
            Title: "About",
            path: "/about",
            portal_type: "Folder",
        },
        ...
        // staff
        {
            UID: "asdfasdf9sdf",
            Title: "Mike",
            path: "/about/staff/mike",
            portal_type: "Document",
        },
        {
            UID: "cvbcvb82345",
            Title: "Joe",
            path: "/about/staff/joe",
            portal_type: "Document",
        },
    ...
    function browse(items, q, p) {
        ...
        _.each(items, function (item) {
            ...
            if (
                ...
                itemSplit.length - 1 === splitPath.length
            ) {
                fromPath.push(item);
            }
        });
...
server.respondWith(
    "GET",
    /portal_factory\/@@querybuilder_html_results/,
    function (xhr, id) {
