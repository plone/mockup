...
(function() {
  ...
  var requirejsOptions = {
    ...
    paths: {
      ...
      'mockup-patterns-toolbar': 'js/patterns/toolbar/pattern',
      ...
      'scroller': 'bower_components/scroller/src/Scroller',
      'scroller-animate': 'bower_components/scroller/src/Animate',
    ...
    shim: {
      ...
      'scroller': { exports: 'window.Scroller', deps: [ 'scroller-animate' ] },
