...
describe("1 - AutoTOC", function () {
    ...
    it("can have custom levels", async function () {
        ...
        expect($("> .nav > li > a.autotoc-level-1", this.$el).length).toEqual(4);
        expect($("> .nav > li > a.autotoc-level-2", this.$el).length).toEqual(0);
    });
    ...
    it("by default the first element is the active one", async function () {
        ...
        expect($("> .nav > li > a.active", this.$el).text()).toEqual("Title 1");
    });
    it("the first element with `classActiveName` will be the active", async function () {
        ...
        expect($("> .nav > li > a.active", this.$el).text()).toEqual("Title 2");
    });
