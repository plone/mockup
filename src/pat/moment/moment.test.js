  ...
  ========================== */
    ...
    describe("Moment", function () {
        ...
        it("test parse relative", function () {
            ...
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:relative">' +
                    date +
                    "</div>"
            );
            registry.scan($el);
        ...
        it("test parse calendar", function () {
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:calendar">2012-10-02 14:30</div>'
            );
            registry.scan($el);
        ...
        it("test parse custom", function () {
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:YYYY">2012-10-02 14:30</div>'
            );
            registry.scan($el);
        ...
        it("test parse custom", function () {
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:YYYY;selector:*"><div>2012-10-02 14:30</div></div>'
            );
            registry.scan($el);
        ...
        it("test parse no date", function () {
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:calendar"><div></div></div>'
            );
            registry.scan($el);
        ...
        it('test parse "None" date', function () {
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:calendar"><div>None</div></div>'
            );
            registry.scan($el);
        ...
        it("test setTitle default (false)", function () {
            var $el = $(
                '<div class="pat-moment" data-pat-moment="format:relative">2012-10-02 14:30</div>'
            );
            registry.scan($el);
