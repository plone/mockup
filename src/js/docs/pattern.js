define(["underscore", "marked", "react", "pat-registry"], function (
    _,
    marked,
    React,
    Registry
        ...
        parsePattern: function (text) {
            ...
            _.each(text.split("\n"), function (line, lineNumber) {
                ...
                if (section.exec(line) !== null) {
                    ...
                    currentSection = currentSection.substring(
                        0,
        ...
        render: function () {
            ...
            if (options) {
                render_options = [
                    ...
                    div(
                        {
                            className:
                                "table-responsive mockup-pattern-configuration",
                        },
                        table(
                            {
                                className:
            ...
            if (license) {
                render_license = [
                    h2({}, "License"),
                    div({
                        className: "mockup-pattern-license",
            ...
            return div(
                { className: "mockup-pattern" },
                [
                    h2({}, "Documentation"),
                    div({
                        className: "mockup-pattern-documentation",
                        dangerouslySetInnerHTML: { __html: documentation },
                    }),
                ]
                    .concat(render_options)
                    .concat(render_license)
            );
        },
    });
